...
if ($manaslu_post_layout == "layout-2") { ?>
    ...
    <main id="site-content" role="main">
        <div id="primary" class="content-area">
            ...
            while (have_posts()) :
                ...
                the_post_navigation(
                    array(
                        'prev_text' => '<span class="nav-subtitle">' . esc_html__('Previous:', 'manaslu') . '</span> <span class="nav-title">%title</span>',
                        'next_text' => '<span class="nav-subtitle">' . esc_html__('Next:', 'manaslu') . '</span> <span class="nav-title">%title</span>',
                    )
                );
                ...
                if ('post' === get_post_type()) :
                    ...
                    $show_author_info = manaslu_get_option('show_author_info');
                    $show_related_posts = manaslu_get_option('show_related_posts');
                    $show_author_posts = manaslu_get_option('show_author_posts');
