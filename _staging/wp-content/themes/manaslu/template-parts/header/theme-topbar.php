...
$hide_topbar_on_mobile = manaslu_get_option('hide_topbar_on_mobile');

$enable_topbar_date = manaslu_get_option('enable_topbar_date');
$enable_topbar_time = manaslu_get_option('enable_topbar_time');

$enable_topbar_nav = manaslu_get_option('enable_topbar_nav');
$enable_topbar_social_icons = manaslu_get_option('enable_topbar_social_icons');
        ...
        <div class="site-topbar-wrapper">
            ...
            <div class="site-topbar-item site-topbar-left">
                <?php if ( $enable_topbar_date ) :
                    $date_format = manaslu_get_option( 'todays_date_format', 'l ,  j  F Y' );
                    ?>
