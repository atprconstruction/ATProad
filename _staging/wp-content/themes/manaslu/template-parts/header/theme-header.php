...
$enable_header_bg_overlay = manaslu_get_option('enable_header_bg_overlay');
$header_image_size = manaslu_get_option('header_image_size');
$enable_top_bar = manaslu_get_option('enable_top_bar');
