...
$related_posts_text = manaslu_get_option('related_posts_text');
$no_of_related_posts = absint(manaslu_get_option('no_of_related_posts'));
$order = esc_attr(manaslu_get_option('related_posts_order'));
$orderby = esc_attr(manaslu_get_option('related_posts_orderby'));
